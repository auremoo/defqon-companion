...
export const attendanceHistory: AttendanceEntry[] = [
  ...
  { year: 2020, cancelled: true, note: 'COVID-19 · thème "Primal Energy" annoncé mais reporté' },
  { year: 2021, cancelled: true, note: 'COVID-19 · "Primal Energy" reporté une seconde fois' },
  { year: 2022, total: 100_000, note: 'Retour après 3 ans · "Primal Energy" enfin tenu' },
